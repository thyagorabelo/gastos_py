import statistics
import os
from modulos import myfunction
from modulos import gastos
def produce_bar_chart(fn):
    ...
    conteudo_html = header + body + footer
    pagina = f"{mes}.html"
    caminho_dados = "/home/thyago_rabelo/Programacao/Python/Useacabeca/dados"
    caminho_final = os.path.join(caminho_dados, pagina)
  
    # ADICIONADO: encoding="utf-8" para salvar o arquivo com acentos
    with open(caminho_final, "w", encoding="utf-8") as sf:
        sf.write(conteudo_html)
